      ...
      <div className="space-y-4 rounded-2xl bg-white/70 p-3">
        {!supported || !hasVapidKey ? (
          <div className="flex flex-col items-center gap-3 py-2 text-center">
            <BellOff className="h-10 w-10 text-pink-400" />
          ...
          <div className="flex flex-col items-center gap-3 py-2 text-center">
            ...
            <p className="text-xs text-pink-900/65">
          ...
          <div className="flex flex-col items-center gap-3 py-2 text-center">
            ...
            <ul className="w-full space-y-1 text-left text-xs text-pink-900/75">
            ...
            <button
              ...
              className="btn-press btn-press-raised mt-1 w-full rounded-2xl bg-pink-500 py-2.5 text-sm font-semibold text-white disabled:opacity-60 disabled:active:transform-none"
            >
